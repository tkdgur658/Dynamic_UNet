...
class UNet_Pyramid_Bottleneck(nn.Module):
    def __init__(self, in_channels=1, out_channels=1, init_features=32):
        super(UNet_Pyramid_Bottleneck, self).__init__()
...
# print(pytorch_model_summary.summary(UNet_Pyramid_Bottleneck(1),torch.rand((1, 1, 512, 512))))
